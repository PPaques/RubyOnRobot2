...
class RegistersControllerTest < ActionController::TestCase
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post :create, register: { address: @register.address, description: @register.description, last_value: @register.last_value, name: @register.name, value: @register.value }
    end
  ...
  test "should update register" do
    put :update, id: @register, register: { address: @register.address, description: @register.description, last_value: @register.last_value, name: @register.name, value: @register.value }
    assert_redirected_to register_path(assigns(:register))
  end
